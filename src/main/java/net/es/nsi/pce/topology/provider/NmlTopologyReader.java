...
import net.es.nsi.pce.nml.jaxb.PortGroupRelationType;
import net.es.nsi.pce.nml.jaxb.PortGroupType;
import net.es.nsi.pce.nml.jaxb.PortRelationType;
import net.es.nsi.pce.nml.jaxb.PortType;
import net.es.nsi.pce.nml.jaxb.TopologyRelationType;
