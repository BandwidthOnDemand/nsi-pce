...
public class TopologyService {
    ...
    public Response getStps(
        ...
        if (labelType != null && !labelType.isEmpty()) {
            for (Iterator<StpType> iter = stps.getStp().iterator(); iter.hasNext();) {
                StpType stp = iter.next();
                for (TypeValueType label : stp.getLabels()) {
                    if (!labelType.contentEquals(label.getType())) {
                        iter.remove();
                    }
                    else if (labelValue != null && !labelValue.isEmpty()) {
                        if (!LabelUtilities.contains(label.getValue(), labelValue)) {
                            iter.remove();
                        }
                    }
                }
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.QUERY_LABEL_VALUE, "/stps", labelValue));
        }
    ...
    public Response getStp(
        ...
        if (stpId == null || stpId.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/stps/{stpId}", "stpId"));
        }
        // Get a reference to topology provider and get the NSI Topology model.
        TopologyProvider topologyProvider = ConfigurationManager.INSTANCE.getTopologyProvider();
        NsiTopology nsiTopology = topologyProvider.getTopology();

        // If the label is URL encoded then it will not come in as a parameter
        // so take it out manually.
        String[] query = queryPattern.split(stpId);
        String labelType = null;
        String labelValue = null;
        if (query.length > 1) {
            stpId = query[0];
            String[] label = labelPattern.split(query[1]);
            if (label.length > 0) {
                // We only have a labelType.
                labelType = label[0];
            }

            if (label.length == 2) {
                // We have a labelType and labelValue.
                labelValue = label[1];
            }
        }
        ...
        if (stp == null) {
            log.debug("getStp: Requested stpId does not exist. " + stpId);
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, stpId, "stpId"));
        }

        // Verify the requested vlan is present before responding (if supplied).
        if (vlan != null && !vlan.isEmpty() && !LabelUtilities.containsVLAN(stp, vlan)) {
            log.debug("getStp: Requested stpId " + stpId + " does not have vlan=" + vlan);
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, stpId, "stpId"));
        }

        // Now check to see if we found a query string encoded.
        if (labelType != null && !labelType.isEmpty() && !LabelUtilities.contains(stp, labelType, labelValue)) {
            log.debug("getStp: Requested stpId " + stpId + " does not have label type=" + labelType + ", value=" + labelValue);
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, stpId, "stpId"));
        }
    ...
    public Response getNetwork(
        ...
        if (networkId == null || networkId.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/networks/{networkId}", "networkId"));
        }
        ...
        if (network == null) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, networkId, "networkId"));
        }
    ...
    public Response getNsa(
        ...
        if (nsaId == null || nsaId.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/nsas/{nsaId}", "nsaId"));
        }
        ...
        if (nsa == null) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, nsaId, "nsaId"));
        }
    ...
    public Response getServiceDomain(
        ...
        if (id == null || id.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/serviceDomains/{serviceDomainId}", "serviceDomainId"));
        }
        ...
        if (serviceDomain == null) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, id, "serviceDomainId"));
        }
    ...
    public Response getServiceDomainsByNetwork(
        ...
        if (networkId == null || networkId.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/networks/{networkId}/serviceDomains", "networkId"));
        }
    ...
    public Response getServiceAdaptation(
        ...
        if (id == null || id.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/serviceAdaptations/{serviceAdaptationId}", "serviceAdaptationId"));
        }
        ...
        if (serviceAdaptation == null) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, id, "serviceAdaptationId"));
        }
    ...
    public Response getServiceAdaptationsByNetwork(
        ...
        if (networkId == null || networkId.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/networks/{networkId}/serviceAdaptations", "networkId"));
        }
    ...
    public Response getService(
        ...
        if (id == null || id.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/services/{serviceId}", "serviceId"));
        }
        ...
        if (service == null) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, id, "serviceId"));
        }
    ...
    public Response getServicesByNetwork(
        ...
        if (networkId == null || networkId.isEmpty()) {
            log.error("getServiceDomainsByNetwork: Path parameter networkId must be provided.");
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/networks/{networkId}/services", "networkId"));
        }
    ...
    public Response getSdp(
        ...
        if (id == null || id.isEmpty()) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.badRequest(TopologyError.PATH_PARAMETER, "/sdps/{stpId}", "stpId"));
        }
        ...
        if (sdp == null) {
            ...
            throw new javax.ws.rs.WebApplicationException(TopologyError.notFound(TopologyError.NOT_FOUND, id, "stpId"));
        }
