...
/**
 * This class marshals and unmarshals PCE Path API messages.  This is
...
public class PathApiParser {
    ...
    private PathApiParser() {
        try {
            ...
            jaxbContextAPI = JAXBContext.newInstance("net.es.nsi.pce.jaxb.path", net.es.nsi.pce.jaxb.path.ObjectFactory.class.getClassLoader());
        }
