...
public class NsaMap {
    private static final HashMap<String, CartesianCoordinates> map = new HashMap<String, CartesianCoordinates>() {
        private static final long serialVersionUID = 1L;
        {
            ...
            this.put("urn:ogf:network:manlan.internet2.edu:2013:", new CartesianCoordinates(400, 350));
            ...
            this.put("urn:ogf:network:kddilabs.jp:2013:topology", new CartesianCoordinates(50, 750));
            ...
            this.put("urn:ogf:network:aist.go.jp:2013:topology", new CartesianCoordinates(400, 750));
            ...
            this.put("urn:ogf:network:sinet.ac.jp:2013:topology", new CartesianCoordinates(200, 850));
        }
    };
